...
\def\fsUniversity{\fontsize{20}{24}\selectfont }
\def\fsTitle{\fontsize{20}{24}\selectfont }
\def\fsNames{\fs{20}[24] }
...
\begin{titlepage}
    \null\vfill
    \begin{center}
                {\fsUniversity{國立中興大學電機工程學系}\par}
        {\fsUniversity{碩士學位論文}\par}
        \vspace*{20mm}
...
%        \vspace*{20mm}
        ...
        {\fsTitle  基於基因演算法之雲端管理系統集群選擇 \par}
        \vspace*{5mm}
        
        {\fsTitle Cluster selection of cloud managerment system based on genrtic algotithm \par}
        \vspace*{10mm}
